 ...
 *
 * Fetches aggregated calendar heatmap data for a specific view.
 */
...
import { ledgerEntries } from "@/features/ledger/server";
import { sourceDocuments } from "@/features/source-document/server";
import { and, eq, isNull, sql } from "drizzle-orm";
import { GetCalendarHeatmapSchema } from "./schemas";
import { getDateRange, normalizeDate, calculateStats } from "./utils";
