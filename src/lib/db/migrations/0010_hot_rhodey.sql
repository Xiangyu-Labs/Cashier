...
INSERT INTO `__new_ledger_entries`("id", "ledger_id", "category_id", "source_document_id", "amount", "currency", "item_name", "description", "converted_amount", "exchange_rate", "metadata", "created_at", "updated_at", "deleted_at") SELECT "id", "ledger_id", "category_id", "source_document_id", "amount", "currency", "item_name", "description", "converted_amount", "exchange_rate", "metadata", "created_at", "updated_at", "deleted_at" FROM `ledger_entries`;--> statement-breakpoint
...
CREATE INDEX `idx_source_docs_ledger_entry_date` ON `source_documents` (`ledger_id`,`entry_date`);