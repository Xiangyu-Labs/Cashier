...
describe("Stage 1 Executor", () => {
                ...
                generate: vi.fn(async (options: AIGenerateOptions): Promise<AIResponse> => {
                    ...
                    if (prompt.includes("currency recognition")) {
                        ...
                        if (currencyCallCount === 1) {
                            return { content: '{"currencies": ["CNY"], "reasoning": "Chinese yuan"}', usage: { promptTokens: 100, completionTokens: 50 } };
                        } else {
                            return { content: '{"currencies": ["USD"], "reasoning": "US dollar"}', usage: { promptTokens: 100, completionTokens: 50 } };
                        }
                    }
                    if (prompt.includes("arbitration")) {
                        return { content: '{"choice": 1, "reason": "CNY is correct"}', usage: { promptTokens: 100, completionTokens: 50 } };
                    }
                    if (prompt.includes("category recognition")) {
                        return { content: '{"categories": ["餐饮"], "reasoning": "food"}', usage: { promptTokens: 100, completionTokens: 50 } };
                    }
                    if (prompt.includes("title extraction")) {
                        return { content: '{"title": "午餐"}', usage: { promptTokens: 100, completionTokens: 50 } };
                    }
                    return { content: '{}', usage: { promptTokens: 100, completionTokens: 50 } };
                }),
            };
            ...
            const mockAI: AIContext = {
                generate: vi.fn(async (options: AIGenerateOptions): Promise<AIResponse> => {
                    ...
                    if (prompt.includes("currency recognition")) {
                        currencyCallCount++;
                        if (currencyCallCount === 1) {
                            return { content: '{"currencies": ["CNY"], "reasoning": "a"}', usage: { promptTokens: 100, completionTokens: 50 } };
                        } else {
                            return { content: '{"currencies": ["USD"], "reasoning": "b"}', usage: { promptTokens: 100, completionTokens: 50 } };
                        }
                    }
                    if (prompt.includes("arbitration")) {
                        return { content: '{"choice": 0, "reason": "Both are wrong"}', usage: { promptTokens: 100, completionTokens: 50 } };
                    }
                    if (prompt.includes("category recognition")) {
                        return { content: '{"categories": ["餐饮"], "reasoning": "r"}', usage: { promptTokens: 100, completionTokens: 50 } };
                    }
                    if (prompt.includes("title extraction")) {
                        return { content: '{"title": "午餐"}', usage: { promptTokens: 100, completionTokens: 50 } };
                    }
    ...
    describe("Cancellation", () => {
        it("should throw when signal is aborted after validity check", async () => {
            ...
            await expect(executeStage1(baseInput, mockAI, controller.signal)).rejects.toThrow("Task cancelled");
        });
    });
});
