...
vi.mock("@/modules/workspace/ui/useLedgerDialogState", () => ({
  useLedgerDialogState: useLedgerDialogStateMock,
}));

vi.mock("@/modules/workspace/ui/useLedgerPagePrefetching", () => ({
  useLedgerPagePrefetching: useLedgerPagePrefetchingMock,
}));

vi.mock("@/modules/workspace/ledger-url-navigation", () => ({
