...
const baselineGzipBytes = 263_253;
const maximumGzipBytes = Math.ceil(baselineGzipBytes * 1.05);
...
if (gzipBytes > maximumGzipBytes) {
  throw new Error(
    `Protected route client footprint regressed by more than 5% (${gzipBytes} > ${maximumGzipBytes})`
  );
}
